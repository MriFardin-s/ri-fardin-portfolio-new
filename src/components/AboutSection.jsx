        ...
        <div className="space-y-6">
          ...
          <div className="pt-4 flex flex-wrap gap-4">
            <a
              ...
              className="group relative flex items-center gap-3 bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-lg shadow-purple-600/25 active:scale-95 overflow-hidden inline-flex"
            >
